...
# Kütüphane Otomasyon Sisteminde neler olur kabaca bakalım;
# -Kütüphaneye üye olabilme
# -Kütüphaneden üyelik silebilme
# -Herhangi bir kütüphaneden kendi adına kitap alabilme.
# -Üye, aldığı kitabı teslim edebilir.

# Bir kütüphane otomasyonunda bunların hepsi olmalıdır.
# İleride işleyeceğimiz class konusu ile çok daha rahat anlaşılacaktır.
# Görelim İsterseniz;
...
# Arkadaşlar biliyorum birçoğunuz anlamadı fakat kütüphane otomasyonu biraz üzerine düşülerek öğrenilecek konu.
# İnternetten python kütüphanelerini araştırarak daha anlaşılır hale getirebilirsiniz.

# Bu dersimizin de sonuna geldik görüşmek üzere....